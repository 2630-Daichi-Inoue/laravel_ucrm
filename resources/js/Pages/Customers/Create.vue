<script setup>
    ...
    const form = reactive({
        name: null, tel: null, email: null, postcode: null, address: null, birthday: null, gender: null, price: null, memo: null
    })
                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label class="leading-7 text-sm text-gray-600">ジェンダー</label>
                                                    ...
                                                    <input type="radio" id="gender3" name="gender" v-model="form.gender" value="2">
                                                    <label for="gender2" class="ml-2 mr-4">秘密</label>
                                                </div>
                                            </div>
